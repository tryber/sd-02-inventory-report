...
class SimpleReport:
    ...
    def generate(cls, products):
        ...
        print(f"Data de fabricação mais antiga: {oldest_fabrication}")
        print(f"Data de validade mais próxima: {nearest_shelf_life}")
        print(
            f"Empresa com maior quantidade de produtos estocados: {most_products_company_name}"
        )
